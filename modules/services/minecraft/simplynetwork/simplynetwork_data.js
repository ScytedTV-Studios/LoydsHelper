...
//         const tagsResponse = await axios.get('https://api.scyted.tv/v2/simplynetwork/data/tags', { headers });
//         const tagsData = tagsResponse.data;

//         const discordResponse = await axios.get('https://api.scyted.tv/v2/simplynetwork/connect/discord', { headers });
...
//                 await axios.post(`https://api.scyted.tv/v2/simplynetwork/data/tags/${name}`, tagPayload, { headers });
...
//                 await axios.post(`https://api.scyted.tv/v2/simplynetwork/connect/discord/${name}`, discordPayload, { headers });
