...
const monitoredAccounts = ["scyted.tv", "cr.scyted.tv", "ope.scyted.tv"];
const bskyAPI = "https://bsky.social/xrpc/";
const apiBaseURL = `https://api.scyted.tv/v2/loydshelper/bluesky/${process.env.LOYD_SCYTED_TV_BSKY_USERNAME}/reposted.json`;

const BSKY_USERNAME = process.env.LOYD_SCYTED_TV_BSKY_USERNAME;
const BSKY_PASSWORD = process.env.LOYD_SCYTED_TV_BSKY_PASSWORD;
