...
const monitoredAccounts = ["team.scyted.tv", "phrasing.scyted.tv", "creators.scyted.tv", "news.scyted.tv", "milo.scyted.tv", "tindalos.scyted.tv", "cr.scyted.tv"];
const bskyAPI = "https://bsky.social/xrpc/";
const apiBaseURL = `https://api.scyted.tv/v2/loydshelper/bluesky/${process.env.SCYTED_TV_BSKY_USERNAME}/reposted.json`;
