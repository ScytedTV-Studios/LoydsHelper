...
const monitoredAccounts = ["loyd.scyted.tv", "wolfmox.bsky.social", "ope.scyted.tv"];
const bskyAPI = "https://bsky.social/xrpc/";
const apiBaseURL = `https://api.scyted.tv/v2/loydshelper/bluesky/${process.env.CREATORS_SCYTED_TV_BSKY_USERNAME}/reposted.json`;

const BSKY_USERNAME = process.env.CREATORS_SCYTED_TV_BSKY_USERNAME;
const BSKY_PASSWORD = process.env.CREATORS_SCYTED_TV_BSKY_PASSWORD;
